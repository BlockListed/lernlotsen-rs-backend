...
pub fn check_entries_belong_to_userid<'a>(mut entries: impl Iterator<Item = &'a crate::db::model::Entry>, user_id: &str) -> WebResult<(), &'static str> {
...
pub fn check_timeslots_belong_to_userid<'a>(mut timeslots: impl Iterator<Item = &'a crate::db::model::TimeSlot>, user_id: &str) -> WebResult<(), &'static str> {
